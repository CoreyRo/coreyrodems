...
const Navbar = () => {
    return(
            ...
            <div className='container-fluid'>
                ...
                <ul className="navbar-nav nav-tabs list-group ml-auto" id="myNavBar">
                    <li className="nav-item">
                        <a className="nav-link soc-links" href="https://github.com/CoreyRo" rel="noopener noreferrer" target='_blank'><i className="fab fa-github"></i> Github <span className="sr-only">(current)</span></a>
                    </li>
                    <li className="nav-item">
                        <a className="nav-link soc-links" href="https://www.linkedin.com/in/coreyrodems/" rel="noopener noreferrer" target='_blank'><i className="fab fa-linkedin"></i> Linkedin <span className="sr-only">(current)</span></a>
                    </li>
                </ul> 
            </div>
        </nav>
        <div className="mid-nav">
            <div className='container-fluid'>
                <h6 className='nav-brand'><i className="far fa-envelope"></i> Email me at <a href='mailto:coreyrodems@gmail.com'> coreyrodems@gmail.com</a></h6>
            </div>
        </div>
                ...
                <div className="collapse navbar-collapse nav-pos" id="navCollapse">
                    ...
                    <ul className="navbar-nav nav-tabs list-group ml-auto" id="myNavBar">
                        <li className={window.location.pathname === '/' || window.location.pathname === '/home' ? 'active nav-item' : 'nav-item'}>
                            <Link className="nav-link bot-link" id='homeLink' to="/"><i className="fas fa-home"></i> Home<span className="sr-only">(current)</span></Link>
                        </li>

                        <li className={window.location.pathname === '/about' ? 'active nav-item' : 'nav-item'}>
                            <Link className="nav-link bot-link" to="/about"><i className="fas fa-info-circle"></i> About <span className="sr-only">(current)</span></Link>
                        </li>

                        <li className={window.location.pathname === '/projects' ? 'active nav-item' : 'nav-item'}>
                            <Link className="nav-link bot-link" to="/projects"><i className="fas fa-folder-open"></i> Projects <span className="sr-only">(current)</span></Link>
                        </li>

                        <li className={window.location.pathname === '/contact' ? 'active nav-item mr-sm-2' : 'nav-item mr-sm-2'}>
                            <a className="nav-link bot-link" href="#contactForm"  data-toggle="modal" data-target="#contactForm"><i className="fas fa-envelope"></i> Contact <span className="sr-only">(current)</span></a>
                        </li>
                    </ul> 
